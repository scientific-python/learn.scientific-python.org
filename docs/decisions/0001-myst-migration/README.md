...
| [0004](0004-consume-cookie-myst-build.md)   | Consume the cookie MyST build                 | Proposed |
...
| [0009](0009-myst-theme-integration.md)      | MyST theme integration via copier             | Proposed |
